...
class TestGeneticAlgorithmInitialization:
    ...
    def test_default_weights(self):
        ...
        ga = GeneticAlgorithm(
            n_players=7, n_matches=20, population_size=10, generations=5
        )
...
class TestInitializePopulation:
    ...
    def test_initialize_population_size(self):
        ...
        ga = GeneticAlgorithm(
            n_players=7, n_matches=10, population_size=5, generations=1
        )
...
class TestTournamentSelection:
    ...
    def test_tournament_selection_favors_better_fitness(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=10, generations=1
        )
        population = ga.initialize_population()
        fitness_scores = [ga.calculate_fitness_for_calendar(cal) for cal in population]
...
class TestGeneticAlgorithmRun:
    ...
    def test_run_returns_best_calendar(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=10, generations=5
        )
    ...
    def test_run_with_small_problem(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=3, population_size=20, generations=10
        )
    ...
    def test_run_improves_over_generations(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=20, generations=20
        )
    ...
    def test_run_with_elitism(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=10, generations=5, elitism_size=2
        )
...
class TestGeneticAlgorithmEdgeCases:
    ...
    def test_small_population(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=3, population_size=2, generations=2
        )
    ...
    def test_single_generation(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=3, population_size=5, generations=1
        )
    ...
    def test_large_elitism(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=3, population_size=10, generations=2, elitism_size=8
        )
...
class TestEarlyStopping:
    ...
    def test_early_stopping_disabled_by_default(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=10, generations=100
        )
    ...
    def test_early_stopping_message_in_verbose_mode(self):
        ...
        if len(ga.best_fitness_history) < 100:
            assert (
                "early stopping" in output.lower() or "stopped early" in output.lower()
            )

...
class TestEndToEnd:
    ...
    def test_different_player_counts(self):
        ...
        for n_players in player_counts:
            ga = GeneticAlgorithm(
                n_players=n_players, n_matches=15, population_size=20, generations=30
            )
...
class TestMainScriptComponents:
    ...
    def test_validate_solution_returns_correct_format(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=8, population_size=10, generations=20
        )
    ...
    def test_fitness_history_tracking(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=10, population_size=15, generations=25
        )
...
class TestEdgeCases:
    ...
    def test_minimum_players(self):
        ...
        ga = GeneticAlgorithm(
            n_players=4, n_matches=5, population_size=10, generations=20
        )
